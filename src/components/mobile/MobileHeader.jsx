      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-background/95 backdrop-blur-md border-b border-[#614E41]">
          ...
          <div className="flex items-center gap-2">
            ...
            <Sheet open={isDrawerOpen} onOpenChange={setIsDrawerOpen}>
              ...
              <SheetContent side="right" className="w-64 p-0 bg-background">
                <SheetHeader className="p-3 border-b border-brand-500">
                  <SheetTitle className="text-left text-foreground text-base">Menu</SheetTitle>
                </SheetHeader>

                <div className="flex flex-col h-full">
                  {/* Wallet Section */}
                  <div className="p-3 border-b border-brand-500">
                    {connected ? (
                      <div className="space-y-2">
                        ...
                        <Button
                          ...
                          size="sm"
                          onClick={disconnect}
                          className="w-full text-foreground h-8 border-brand-500"
                        >
                          Disconnect
                        </Button>
                      </div>
                  ...
                  {/* Settings Section */}
                  <div className="p-3 border-t border-brand-500 space-y-2">
                    {/* Theme Toggle */}
        ...
        {showSearch && (
          <div
            ...
            className="px-4 pb-3 border-t border-brand-500/50 animate-in slide-in-from-top-2 duration-200"
          >
