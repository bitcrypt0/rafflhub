      ...
      <Card variant="elevated" className="p-8 max-w-3xl mx-auto text-center">
        ...
        >
          <div className="mb-6">
            ...
            <p className="text-muted-foreground">Your ERC721 drop raffle has been deployed to the blockchain.</p>
          </div>
    ...
    <div className="relative">
      ...
      <Card variant="elevated" className="p-6 max-w-3xl mx-auto relative z-10">
        <div className="mb-6">
          ...
          <p className="text-sm text-muted-foreground">Create a raffle for NFT collection drops</p>
        </div>
